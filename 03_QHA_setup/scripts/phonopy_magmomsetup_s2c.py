...
sys.path.append(sys.path[0] + '/home/wz300646/Scripts/Utilities_nu/')
...
def main(args):
    ...
    mapped_elem = func.map_elements(small_header,magmom_cell)
    ...
    for f in mapped_elem[0]:
        ...
        count+=1
    supercell_quantity = supercell_quantity*supercell[2]
    ...
    newname = 'INCAR_' + str(args.supercell)
